...
public class HeroData {
    private static String[] title = new String[] {"Ahmad Dahlan","Ahmad Yani","Bung Tomo","Gatot Subroto",
            "Ki Hajar Dewantara","Mohammad Hatta","Sudirman","Sukarnno","Supomo","Tan Malaka"};

    private static int[] thumbnail = new
            int[]{R.drawable.ahmad_dahlan,R.drawable.ahmad_yani,R.drawable.bung_tomo,R.drawable.gatot_subroto,
            R.drawable.ki_hadjar_dewantara,R.drawable.mohammad_hatta,R.drawable.sudirman,R.drawable.sudirman,
            R.drawable.sukarno,R.drawable.supomo,R.drawable.tan_malaka};
